...
import { ICategory, ILanguage, IPost } from "@/interfaces/post";
import { postFormSchema } from "@/interfaces/zod/post-schema";

export default function EditPostById({ params }: { params: any }) {
  ...
  const form = useForm<z.infer<typeof postFormSchema>>({
    ...
    defaultValues: {
      ...
      language: (response?.language as ILanguage).code,
      content: response?.content,
      category: (response?.category as ICategory).name,
      tags: response?.tags,
      thumbnail: undefined,
  ...
  if (isPreview)
    return (
      <>
        ...
        <PostPreview post={form.getValues() as IPost} />
      </>
    );
